...
Publishing an installer requires Azure Artifact Signing. The bundle script fails release uploads when signing is unavailable, verifies the signed installer with `signtool`, and creates the checksum sidecar only after signing.
