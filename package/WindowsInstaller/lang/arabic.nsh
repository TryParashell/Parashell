...
${LangFileString} TEXT_FINISH_WEBSITE "زيارة https://www.parashell.cloud لمشاهدة آخر الاخبار, الدعم والأفكار"
...
${LangFileString} SecUnPreferencesDescription 'حذف Parashell$\'s ضبط$\r$\n\
