...
${LangFileString} TEXT_FINISH_WEBSITE "Bisitatu parashell.cloud azken berriak, aholkuak eta laguntza lortzeko"

#${LangFileString} FileTypeTitle "Parashell-dokumentua"
...
${LangFileString} SecCoreDescription "Parashell fitxategiak."
#${LangFileString} SecAllUsersDescription "Instalatu Parashell erabiltzaile guztientzako, edo soilik uneko erabiltzailearentzako."
${LangFileString} SecFileAssocDescription ".FCStd luzapeneko fitxategiak Parashell-ekin irekiko dira automatikoki."
${LangFileString} SecDesktopDescription "Parashell ikonoa mahaigainean."
...
#${LangFileString} ConfigInfo "Parashell-en hurrengo konfigurazioak denbora piskat beharko du."
...
#${LangFileString} FinishPageMessage "Zorionak! Parashell ongi instalatu da.$\r$\n\
#					$\r$\n\
#					(Parashell aurreneko aldiz abiatzean denbora piskat beharko du.)"
${LangFileString} FinishPageRun "Abiarazi Parashell"

${LangFileString} UnNotInRegistryLabel "Ezin da Parashell aurkitu erregistroan.$\r$\n\
					Mahaigaineko eta Hasiera menuko lasterbideak ez dira kenduko."
${LangFileString} UnInstallRunning "Aurrenik Parashell itxi behar duzu."
${LangFileString} UnNotAdminLabel "Administratzailearen baimenak behar dituzu Parashell desinstalatzeko."
${LangFileString} UnReallyRemoveLabel "Ziur zaude Parashell eta bere osagai guztiak kentzea nahi dituzula??"
${LangFileString} UnFreeCADPreferencesTitle 'Parashell-eko erabiltzailearen hobespenak'

#${LangFileString} SecUnProgDescription "xxx kudeatzailea desinstalatzen du."
${LangFileString} SecUnPreferencesDescription 'Parashell-en konfigurazioa ezabatzen du$\r$\n\
