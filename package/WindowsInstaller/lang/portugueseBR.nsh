...
${LangFileString} TEXT_FINISH_WEBSITE "Visite parashell.cloud para ver as últimas novidades do Parashell!"
...
${LangFileString} SecCoreDescription "Os arquivos do Parashell."
#${LangFileString} SecAllUsersDescription "Instalar o Parashell para todos os usuários ou apenas para o usuário atual."
${LangFileString} SecFileAssocDescription "Arquivos com a extensão .FCStd serão abertos automaticamente no Parashell."
${LangFileString} SecDesktopDescription "Um ícone do Parashell na área de trabalho."
...
#${LangFileString} ConfigInfo "A configuração do Parashell que será feita a seguir vai demorar bastante."
...
#					$\r$\n\
#					(A primeira execução do Parashell pode demorar alguns segundos.)"
${LangFileString} FinishPageRun "Executar o Parashell"

${LangFileString} UnNotInRegistryLabel "Não foi possível encontrar o Parashell no Registro.$\r$\n\
					Os atalhos na área de trabalho e no Menu Iniciar não serão removidos."
${LangFileString} UnInstallRunning "É necessário fechar o Parashell primeiro!"
${LangFileString} UnNotAdminLabel "Para desinstalar o Parashell é necessário ter privilégios de administrador!"
${LangFileString} UnReallyRemoveLabel "Tem certeza que deseja remover completamente o Parashell e todos os seus componentes?"
${LangFileString} UnFreeCADPreferencesTitle 'Preferências de usuário do Parashell'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Exclui a configuração do Parashell$\r$\n\
