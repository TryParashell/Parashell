...
${LangFileString} TEXT_WELCOME "Dit installatie programma zal Parashell op uw systeem installeren.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} SecCoreDescription "De Parashell bestanden."
#${LangFileString} SecAllUsersDescription "Installeer Parashell voor alle gebruikers of uitsluitend de huidige gebruiker?"
${LangFileString} SecFileAssocDescription "Associeer het Parashell programma met de .FCStd extensie."
${LangFileString} SecDesktopDescription "Een Parashell pictogram op het Bureaublad."
...
#${LangFileString} ConfigInfo "De volgende configuratie van Parashell zal enige tijd duren."
...
${LangFileString} AlreadyInstalled "Parashell ${APP_SERIES_KEY2} is reeds geinstalleerd!$\r$\n\
...
#${LangFileString} FinishPageMessage "Gefeliciteerd! Parashell is succesvol geinstalleerd.$\r$\n\
#					$\r$\n\
#					(De eerste keer dat u Parashell start kan dit enige seconden duren.)"
${LangFileString} FinishPageRun "Start Parashell"

${LangFileString} UnNotInRegistryLabel "Parashell is niet gevonden in het Windows register.$\r$\n\
					Snelkoppelingen op het Bureaublad en in het Start Menu worden niet verwijderd."
${LangFileString} UnInstallRunning "U moet Parashell eerst afsluiten!"
${LangFileString} UnNotAdminLabel "U heeft systeem-beheerrechten nodig om Parashell te verwijderen!"
${LangFileString} UnReallyRemoveLabel "Weet u zeker dat u Parashell en alle componenten volledig wil verwijderen van deze computer?"
${LangFileString} UnFreeCADPreferencesTitle 'Parashell$\'s user preferences'

#${LangFileString} SecUnProgDescription "Verwijder xxx."
${LangFileString} SecUnPreferencesDescription 'Verwijder Parashell$\'s configuratie map$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Verwijder Parashell en alle bijbehorende onderdelen."
