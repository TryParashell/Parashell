...
if(BUILD_GUI AND FREECAD_QT_MAJOR_VERSION EQUAL 6)
    ...
    if(TARGET Qt6::WebEngineQuick)
        set(QtWebEngineQuick_LIBRARIES Qt6::WebEngineQuick)
        get_target_property(QtWebEngineQuick_INCLUDE_DIRS Qt6::WebEngineQuick INTERFACE_INCLUDE_DIRECTORIES)
        if(NOT QtWebEngineQuick_INCLUDE_DIRS)
            set(QtWebEngineQuick_INCLUDE_DIRS "")
        endif()
        set(QtWebEngineQuick_FOUND TRUE)
        set(QtWebEngineQuick_VERSION ${Qt6WebEngineQuick_VERSION})
        message(STATUS "Qt6 WebEngineQuick ${QtWebEngineQuick_VERSION} found: in-application WebEngine views enabled")
    else()
        set(QtWebEngineQuick_LIBRARIES "")
        set(QtWebEngineQuick_INCLUDE_DIRS "")
